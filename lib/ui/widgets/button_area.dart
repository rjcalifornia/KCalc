                  ...
                  Row(
                    ...
                    children: [
                      buttonHelper('AC', const Color(0xff23252d),
                          const Color(0xff02c984), () => widget.function('AC')),
                      buttonHelper(
                          '+/-',
                      ...
                      buttonHelper('%', const Color(0xff23252d),
                          const Color(0xff02c984), () => widget.function('%')),
                      buttonHelper("÷", const Color(0xff23252d),
                          const Color(0xffc14a51), () => widget.function('÷')),
                    ],
                  ),
                  const SizedBox(
                    height: 18,
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      buttonHelper('9', const Color(0xff23252d),
                          const Color(0xffffffff), () => widget.function('9')),
                      buttonHelper("*", const Color(0xff23252d),
                          const Color(0xffc14a51), () => widget.function('*')),
                    ],
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      buttonHelper('4', const Color(0xff23252d),
                          const Color(0xffffffff), () => widget.function('4')),
                      buttonHelper('5', const Color(0xff23252d),
                          const Color(0xffffffff), () => widget.function('5')),
                      buttonHelper('6', const Color(0xff23252d),
                          const Color(0xffffffff), () => widget.function('6')),
                      buttonHelper("-", const Color(0xff23252d),
                          const Color(0xffc14a51), () => widget.function('-')),
                    ],
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      buttonHelper('1', const Color(0xff23252d),
                          const Color(0xffffffff), () => widget.function('1')),
                      buttonHelper('2', const Color(0xff23252d),
                          const Color(0xffffffff), () => widget.function('2')),
                      buttonHelper('3', const Color(0xff23252d),
                          const Color(0xffffffff), () => widget.function('3')),
                      buttonHelper("+", const Color(0xff23252d),
                          const Color(0xffc14a51), () => widget.function('+')),
                    ],
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      buttonHelper('0', const Color(0xff23252d),
                          const Color(0xffffffff), () => widget.function('0')),
                      buttonHelper('.', const Color(0xff23252d),
                          const Color(0xffffffff), () => widget.function('.')),
                      buttonHelper("=", const Color(0xff23252d),
                          const Color(0xffc14a51), () => widget.function('=')),
                    ],
                  )
